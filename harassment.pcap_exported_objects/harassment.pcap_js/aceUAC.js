var ACE3Host1='http://candi.beta.advertising.com'
var ACE3Host2='http://servedby.advertising.com'
var ACE3Host1Var='as=0'
var ACE3Host2Var='as=1'
var ACE3NewHost=new Array()
ACE3NewHost['727732']=50
ACE3NewHost['741495']=50
ACE3NewHost['743198']=50
ACE3NewHost['721134']=50
ACE3NewHost['738311']=50
ACE3NewHost['736030']=50
ACE3NewHost['736728']=50
ACE3NewHost['744049']=50
ACE3NewHost['744140']=50
ACE3NewHost['742531']=50
ACE3NewHost['710186']=50
//ACE3NewHost['728340']=50
ACE3NewHost['742720']=50
ACE3NewHost['741373']=50
ACE3NewHost['726746']=50
ACE3NewHost['711538']=50
ACE3NewHost['730759']=50
ACE3NewHost['710076']=50
ACE3NewHost['706729']=50
ACE3NewHost['727444']=50
ACE3NewHost['742529']=50
ACE3NewHost['743167']=50
ACE3NewHost['703798']=50
//ACE3NewHost['728278']=50
ACE3NewHost['738344']=50
ACE3NewHost['743252']=50
ACE3NewHost['723899']=50
ACE3NewHost['734847']=50
ACE3NewHost['743843']=50
ACE3NewHost['736808']=50
ACE3NewHost['734100']=50
ACE3NewHost['735115']=50
ACE3NewHost['746164']=50
ACE3NewHost['741583']=50
ACE3NewHost['734865']=50
ACE3NewHost['695864']=50
ACE3NewHost['701012']=50
ACE3NewHost['709856']=50
ACE3NewHost['722173']=50
ACE3NewHost['722174']=50
ACE3NewHost['747297']=50
ACE3NewHost['721490']=50
ACE3NewHost['742468']=50
ACE3NewHost['743013']=50
ACE3NewHost['699875']=50
ACE3NewHost['744097']=50
ACE3NewHost['725658']=50
ACE3NewHost['740024']=50
ACE3NewHost['745337']=50
ACE3NewHost['735916']=50
ACE3NewHost['734689']=50
//ACE3NewHost['721569']=50
//ACE3NewHost['738222']=50
//ACE3NewHost['716450']=50
var ACE3GlobalHostPercent=10 
var ACE3GlobalHost='http://r1.beta.ace.advertising.com'
...
var obj=new Object()
for (var p in ob){var lcn=p.toLowerCase()
...
try {ur+=escape(top.location.href)
...
if (window.ACE_FreqSiteMap&&ACE3Ck!=0){var cn='AdCom'+obj.site,n=ACE3getCk(cn),fd=0
if (!n||n==''){var nu=0
var ED=new Date()
ED.setTime(ED.getTime()+(24*3600000))
var EDs=ED.toGMTString()}
else var n1=n.split('|'),EDs=n1[1],nu=parseInt(n1[0])
for (var i=0;i<ACE_FreqSiteMap.length;i=i+2){if (nu < parseInt(ACE_FreqSiteMap[i])){
...
for (var n in nmVal){if (obj[n]&&(typeof(obj[n])!='function')){
...
else{var v=obj.host;ht=(v.indexOf('http')==-1?"http://"+v:v)
}}
...
if (pf){var i=pf.indexOf(','),n=pf.substring(1,i-1),hr=pf.substring(i+1,pf.length)
...
if (pt=="POPOVER")ot+='/pops=1'
else if (pt=="POPUNDER")ot+='/pops=6'
else if (pt=="POPNOWRAPPER")ot+='/pops=4/bin=1'
else if (pt=="POPHTML")ot+='/pops=4/tags=1'
else if (obj.poponunload=='true')ot+='/pops=3'
if (obj.burl=='true')bu="/burl"
var s=ht+bu+"/site="+site+szs+"/u=1/bnum="+bnum+ot
if (!old&&ct!='IMAGE'&&ct!='I'){if (!ACE3FV)ACE3CkPlg()
s+="/fv="+ACE3FVer
...
if (pNo){if (obj.popdelay)var t=setTimeout("document.write(dw)",obj.popdelay*1000)
else document.write(dw)}
window.ACE_KeyParm=''
window.ACE_KeyParms=''
