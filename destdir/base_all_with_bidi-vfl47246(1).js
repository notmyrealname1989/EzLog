...
function loadGeoOnebox(dummyImage,geoName,geoLatLong,searchQuery,isFirstPass){
var data=new Array();
...
dummyImage.parentNode.replaceChild(newElement,dummyImage);
}else if(isFirstPass){
loadGeoOnebox(dummyImage,geoName,geoLatLong,geoName,false);
